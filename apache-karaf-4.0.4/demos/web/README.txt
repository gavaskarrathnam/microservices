...
[uninstalled] [4.0.4 ] wrapper           standard-4.0.4      Provide OS integration
[uninstalled] [4.0.4 ] obr               standard-4.0.4      Provide OSGi Bundle Repository (OBR) support
[uninstalled] [4.0.4 ] config            standard-4.0.4      Provide OSGi ConfigAdmin support
[uninstalled] [4.0.4 ] region            standard-4.0.4      Provide Region commands
[uninstalled] [7.5.4.v20111024] jetty             standard-4.0.4      Provide Jetty engine support
[uninstalled] [4.0.4 ] http              standard-4.0.4      Implementation of the OSGI HTTP Service
[uninstalled] [4.0.4 ] http-whiteboard   standard-4.0.4      Provide HTTP Whiteboard pattern support
[uninstalled] [4.0.4 ] war               standard-4.0.4      Turn Karaf as a full WebContainer
[uninstalled] [4.0.4 ] deployers         standard-4.0.4      Provide Karaf deployer
[uninstalled] [4.0.4 ] kar               standard-4.0.4      Provide KAR (KARaf archive) support
[uninstalled] [4.0.4 ] webconsole-base   standard-4.0.4      Base support of the Karaf WebConsole
[uninstalled] [4.0.4 ] webconsole        standard-4.0.4      Karaf WebConsole for administration and monitoring
[uninstalled] [4.0.4 ] ssh               standard-4.0.4      Provide a SSHd server on Karaf
...
Maven builds the web application, web-4.0.4.war, and
